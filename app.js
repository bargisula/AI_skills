...
const fallbackArticles = [
  {
    ...
    workflow: [
      ...
      { step: "請 Codex 盤點內容", prompt: "請你看過這個資料夾裡的所有檔案，列出檔名、檔案類型，並簡短說明你認為這份檔案的用途。先只回報，不要修改、搬移或刪除任何檔案。" },
      { step: "請 Codex 建議安全的第一個任務", prompt: "根據你剛才的盤點結果，幫我列出 3 個風險低、容易驗收的候選任務（例如分類、整理、列清單），並說明為什麼適合當作第一個任務。" },
      { step: "執行並人工驗收", prompt: "請執行第一個建議任務，過程中先說明你打算怎麼做，完成後列出實際改動了哪些檔案，讓我逐一核對。" },
      { step: "沉澱成規則文件", prompt: "這次任務完成後，幫我把資料夾理解、任務原則和這次的處理方式寫成一份 AGENTS.md 規則文件，讓下次可以直接沿用。" }
    ],
