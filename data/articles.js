window.AI_SKILLS_ARTICLES = [
  {
    ...
    "sections": [
      {
        "heading": "這篇在講什麼",
        "body": "文章主張 Codex 的價值不只屬於工程師。只要把工作資料放進一個可控的專案資料夾，Codex 就能協助整理文件、處理 PDF、分析表格、建立簡報草稿，甚至做出小型工具。"
      },
      {
        "heading": "最重要的分工",
        "body": "ChatGPT 更適合用來討論方向、研究資料、拆解任務與復盤；Codex 更適合接手實際文件與資料夾，完成具體成果。這種分工能避免把所有事情都塞進單一聊天視窗。"
      },
      {
        "heading": "上手方式",
        "body": "作者建議先建立副本資料夾，把旅行票券、理財月報、課程講義、網站草稿或客戶訪談資料放進去。第一步只讓 Codex 盤點，不要立刻刪除、搬移或重命名。"
      },
      {
        "heading": "可驗收的小任務",
        "body": "好的第一個任務應該小、明確、容易確認，例如分類票券、整理行程、列出檔案用途、找出三個安全任務。這比一開始要求完整自動化更穩。"
      },
      {
        "heading": "沉澱成規則",
        "body": "當流程跑通後，讓 Codex 建立專案規則文件，記錄目標、資料夾理解、任務原則與下次處理方式。這讓 AI 助理不是每次從零開始。"
      }
    ],
    "workflow": [
      "建立副本資料夾",
  ...
  },
  {
    ...
    "sections": [
      {
        "heading": "這篇在講什麼",
        "body": "文章整理作者近期使用 Codex 的知識工作場景，包括行銷文案、課程提詞簡報、PDF 處理、素材拆解、學習平台與 AI 操作流程。"
      },
      {
        "heading": "核心觀念",
        "body": "不要把 Codex 當成從零幻想答案的工具，而是把它放進已有資料、文件、規則與專案脈絡中，讓它接手中間步驟。"
      },
      {
        "heading": "最適合交給 Codex 的任務",
        "body": "重複、繁瑣、格式明確、資料來源已存在、需要跨文件整理的工作，特別適合讓 Codex 先做初稿或批次處理。"
      },
      {
        "heading": "人的角色",
        "body": "人仍然負責定義目標、給出限制、驗收成果、判斷哪些素材值得保留，以及把成功流程變成下一次可沿用的規則。"
      }
    ],
    "workflow": [
      "讓 Codex 讀專案脈絡",
